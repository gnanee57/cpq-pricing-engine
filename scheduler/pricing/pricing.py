...
def create_price_evaluation(pricing_dict, isHold, quote_period_days,
                            ...
                            payment_period, free_days, processing_days, processing_cost):
    try:
        ...
        rolling_sum, customer_sum = total_sum[1:36], total_sum[36:72]
        ...
        unit_cal_index = {1, 2, 4, 12, 14, 17, 18, 19, 20, 21, 22, 23, 24, 25, 28, 29, 30, 32, 34}
...
def calculate_pricing(mprnData, unique_mprn_count, quote_period_days, rolling_aq_sum, customer_aq_sum,
                      ...
                      xo_admin_dict, timing_risk_data, hedging_cost_dict, hedging_risk_dict, imb_cost_dict,
                ...
                if len(fail_remarks) == 0:
                    ...
                    evaluation_data, daywise_data, error, status = \
                        create_price_evaluation(pricing_dict, is_hold, quote_period_days, holdRollingUnitRate,
                                                ...
                                                free_days, processing_days, processing_cost)
                    if status:
...
def pre_pricing(mprn_data, unique_mprn_count, price_curve_data_dict, ecn_data, gnt_data, zco_data, zca_data,
                ...
                ggl_variable_data, xo_admin_data, timing_risk_data, hedging_cost_data, hedging_risk_data, imb_cost_data,
